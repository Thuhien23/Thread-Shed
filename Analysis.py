...
#------------------------------------------------
# Start coding below!
# Replace all the instances of ";,;" in "+"
daily_sales_replaced = daily_sales.replace(";,;", "+")
#Split daily_sales_replaced around commas into a list of each individual transaction
daily_transactions = daily_sales_replaced.split(",")
#print(daily_transactions)

# iterate through daily_transactions
...
transactions_clean = []
for n in daily_transactions_split:
  transaction_clean = []
  for i in n:
    transaction_clean.append(i.strip(" "))
...
#we want to know how much Thread Shed made in a day.
total_sales = 0
for sale in sales:
...
# Define a list called colors that stores all of the colored threads
